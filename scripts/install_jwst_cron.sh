...
CONVERT_LINE='0 23 * * * '"${PYTHON_BIN}"' /home/jaimelop/spacenet/scripts/convert_fits_to_png.py --in-root /mnt/personal_drive/jwst/fits --out-root /mnt/personal_drive/jwst/fits_png >> /mnt/personal_drive/jwst/logs/jwst_fits_png_$(date +\%F).log 2>&1'
